  ...
  return (
    <div className="min-h-screen dark:bg-[#0F172A] flex flex-col justify-center px-6">
      ...
      <div className="glass-card p-6">
        <h2 className="text-xl font-bold text-gray-100 mb-1">Buat Akun</h2>
        <p className="text-sm text-gray-400 mb-6">Daftar untuk mulai tracking</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-sm text-gray-400 mb-2 block">Nama</label>
            <input
              type="text"
              value={name}
