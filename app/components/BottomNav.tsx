...
export default function BottomNav() {
  ...
  const linkClass = (path: string) =>
    `flex flex-col items-center gap-1 p-2 transition ${isActive(path) ? "text-dark dark:text-gray-100" : "text-grayText hover:text-dark dark:hover:text-gray-100 hover:opacity-70"}`;

  return (
    <>
      <nav className="fixed bottom-4 left-4 right-4 bg-white dark:bg-darkCard border border-grayMid/30 dark:border-gray-700 z-50 max-w-md mx-auto rounded-3xl shadow-lg shadow-black/5">
        <div className="flex justify-around items-center py-2 px-2">
          ...
          <div className="relative">
            ...
            {moreMenuOpen && (
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-white dark:bg-darkCard rounded-2xl shadow-xl border border-grayMid/30 dark:border-gray-700 p-2 min-w-[140px]">
                <Link href="/goals" className="flex items-center gap-2 px-3 py-2 rounded-xl hover:bg-grayLight dark:hover:bg-gray-700 transition">
                  ...
                  <span className="text-sm dark:text-gray-200">Goals</span>
                </Link>
                <Link href="/debt" className="flex items-center gap-2 px-3 py-2 rounded-xl hover:bg-grayLight dark:hover:bg-gray-700 transition">
                  <svg className="w-4 h-4 text-grayText" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <circle cx="12" cy="12" r="10" strokeWidth={2} />
                    <line x1="12" y1="8" x2="12" y2="12" strokeWidth={2} />
                    <line x1="12" y1="16" x2="12.01" y2="16" strokeWidth={2} />
                  </svg>
                  <span className="text-sm dark:text-gray-200">Debt</span>
                </Link>
                <Link href="/trials" className="flex items-center gap-2 px-3 py-2 rounded-xl hover:bg-grayLight dark:hover:bg-gray-700 transition">
                  <svg className="w-4 h-4 text-grayText" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                  <span className="text-sm dark:text-gray-200">Trials</span>
                </Link>
                <Link href="/subs" className="flex items-center gap-2 px-3 py-2 rounded-xl hover:bg-grayLight dark:hover:bg-gray-700 transition">
                  <svg className="w-4 h-4 text-grayText" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm dark:text-gray-200">Subs</span>
                </Link>
                <Link href="/daily" className="flex items-center gap-2 px-3 py-2 rounded-xl hover:bg-grayLight dark:hover:bg-gray-700 transition">
                  <svg className="w-4 h-4 text-grayText" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <rect x="3" y="4" width="18" height="18" rx="2" strokeWidth={2} />
                    <line x1="16" y1="2" x2="16" y2="6" strokeWidth={2} />
                    <line x1="8" y1="2" x2="8" y2="6" strokeWidth={2} />
                  ...
                  <span className="text-sm dark:text-gray-200">Daily</span>
                </Link>
                <div className="border-t border-grayMid/30 dark:border-gray-700 my-1"></div>
                <Link href="/settings" className="flex items-center gap-2 px-3 py-2 rounded-xl hover:bg-grayLight dark:hover:bg-gray-700 transition">
                  <svg className="w-4 h-4 text-grayText" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm dark:text-gray-200">Settings</span>
                </Link>
              </div>
            )}
          </div>
